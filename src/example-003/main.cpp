...
void vtx::init(vtx::VertexContext* ctx)
{
    ...
    // clang-format off
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(MyVertex), (void*)  0);                  // position
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(MyVertex), (void*)( 3 * sizeof(float))); // color
    glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(MyVertex), (void*)( 6 * sizeof(float))); // normal
    // clang-format on
